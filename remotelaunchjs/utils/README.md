...
#### Ubuntu 14.04
 ...
 3. Install the Grunt tasks specific to this project
   * `cd /path/to/remotelaunchjs/utils/`
   * `npm install .`
...
To run the build tasks:
 ...
 1. `cd /path/to/remotelaunchjs/utils/`
 2. `grunt build`

`grunt build` will concatenate and minimize the files under src and replace remotelaunch.js and remotelaunch.min.js in the build directory. It will also run the linter and test cases.
